...
class MasterModel extends CI_Model{
    ...
    public function getCompanyInfo($cm_id=1){
		$data['tableName'] = 'company_info';
        $data['select'] = "company_info.*, bcountry.name as company_country_name, bstate.name as company_state_name, bstate.gst_statecode as company_state_code, dcountry.name as delivery_country_name, dstate.name as delivery_state_name, dstate.gst_statecode as delivery_state_code";
