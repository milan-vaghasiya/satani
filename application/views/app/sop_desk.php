			...
			<div class="container">
				<div class="header-content">
					...
					<div class="right-content ">
						<a href="<?=base_url("app/sop/scanSop")?>"  class="badge badge-md badge-primary float-end rounded-sm" datatip="Scan PRC" flow="down">Scan</a>
...
$(document).ready(function(){
	...
	$(document).on('click','.stageFilter',function(){
        ...
        var postdata = $(this).data('postdata') || {status:1,stage:'PRC'};
...
function loadSop(){
	var rec_per_page = "<?=$rec_per_page?>";
	var postdata = {status:2,stage:'New'};
	$("#desk_title").html(postdata.stage);
	$("#status").val(postdata.status);
	var np = parseFloat($('#next_page').val()) || 0;
	postdata.start = 0;
