				...
				<div class="page-title-box">
                    <div class="float-start">
					    <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"> 
                                <button onclick="statusTab('salesOrderTable',3);" id="pending_so" class="nav-tab btn waves-effect waves-light btn-outline-warning" style="outline:0px" data-toggle="tab" aria-expanded="false">Approved</button> 
                            </li>
                            <li class="nav-item"> 
