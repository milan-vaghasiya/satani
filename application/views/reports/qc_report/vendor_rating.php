                            ...
                            <div class="table-responsive">
                                <table id='reportTable' class="table table-bordered">
									...
									<tr class="text-center">
										<th colspan="16">VENDOR RATING REPORT</th>
									</tr>
...
$(document).ready(function(){
    ...
    $(document).on('click','.loadData',function(e){
		...
		if(valid){
            if(is_pdf == 0){
				$.ajax({
					url: base_url + controller + '/getVendorRating',
					data: postData,
					type: "POST",
					dataType:'json',
				...
				var url = base_url + controller + '/getVendorRating/' + encodeURIComponent(window.btoa(JSON.stringify(postData)));
				window.open(url);
			}
        }
    });   
