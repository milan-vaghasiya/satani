...
function AddRow(data) {
	...
	var returnInput = $("<input/>",{type:"hidden",name:"itemData["+countRow+"][is_returnable]",value:data.is_returnable});
	cell = $(row.insertCell(-1));
	cell.html(data.is_returnable);
